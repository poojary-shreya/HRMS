...
const MonthlyTaxSpecific = () => {
  ...
  const fetchMonthlyTax = async () => {
    ...
    try {
      ...
      setTaxData(response.data.totalTaxPaid || null);
      setEmployeeDetails({
        ...
        {taxData && (
          <>
            <Paper elevation={3} sx={{ padding: "20px", textAlign: "center", marginBottom: "20px", marginTop: "20px" }}>
              <Typography variant="h5" fontWeight="bold">{employeeDetails.companydetails.companyname||"N/A"}</Typography>
              <Typography variant="body1">{employeeDetails.companydetails.address||"N/A"}</Typography>
              <Typography variant="body1">{employeeDetails.companydetails.branchLocation||"N/A"}</Typography>
            </Paper>
            ...
            <Table sx={{ marginTop: "20px", border: "1px solid #ddd" }}>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>₹{taxData.toFixed(2)}</TableCell>
                  <TableCell>
