          ...
          <Box sx={{ p: 2 }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                ...
                <Typography><strong>Income Tax:</strong> ₹{payslip.payslip.total_tax.toFixed(2)}</Typography>
                
               
                {payslip.payslip.total_deductions > 0 && (
                  <Typography><strong>Investment Deductions:</strong> ₹{payslip.payslip.total_deductions.toFixed(2)}</Typography>
                )}
