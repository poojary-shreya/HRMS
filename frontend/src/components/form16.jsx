            ...
            <Table>
              <TableBody>
                ...
                <TableRow sx={{ bgcolor: '#f8f8f8' }}>
                  ...
                  <TableCell align="right" sx={{ fontWeight: 'bold' }}>
                    {(
                      parseFloat(formData.partB.salary_income || 0) +
                      parseFloat(formData.partB.perquisites_section_17_2 || 0) +
                      parseFloat(formData.partB.profits_in_lieu_salary_section_17_3 || 0)
                    ).toFixed(2)}
                  </TableCell>
                </TableRow>
              </TableBody>
